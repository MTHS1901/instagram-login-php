...
// User agent, se não, não vai pai
$user_agent = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/98.0.4758.102 Safari/537.36";

$url = "https://www.instagram.com/";

// Request feito em CURL, para tentar obter o csrf_token da página
$ch = curl_init();
...
$body = "enc_password=#PWD_INSTAGRAM_BROWSER:0:{$g}:{$password}&username={$username}"; // 0 significa que a senha não esta codificada
$url = "https://www.instagram.com/api/v1/web/accounts/login/ajax/"; // pra onde vai o request
